...
namespace KMChartsUpdater.DAL.Migrations
{
    ...
    [Migration("20210621192823_ChartItem")]
            ...
            modelBuilder.Entity("KMChartsUpdater.DAL.Entities.ChartFix", b =>
                {
                    ...
                    b.HasIndex("GlobalFixId");

                    b.ToTable("ChartFixes");
                });

            modelBuilder.Entity("KMChartsUpdater.DAL.Entities.GlobalFix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KMChartsUpdater.DAL.Entities.ChartFix", b =>
                {
                    ...
                    b.HasOne("KMChartsUpdater.DAL.Entities.GlobalFix", "GlobalFix")
                        .WithMany("ChartFixes")
                        .HasForeignKey("GlobalFixId");

                    b.Navigation("Chart");

                    b.Navigation("GlobalFix");
                });
