...
namespace KMChartsUpdater.DAL.Migrations
{
    ...
    [Migration("20210902085417_Playlists")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlaylistPositionFix", b =>
                {
                    b.Property<int>("PlaylistsId")
                        .HasColumnType("int");

                    b.Property<int>("PositionFixesId")
                        .HasColumnType("int");

                    b.HasKey("PlaylistsId", "PositionFixesId");

                    b.HasIndex("PositionFixesId");

                    b.ToTable("PlaylistPositionFix");
                });
            ...
            modelBuilder.Entity("PlaylistPositionFix", b =>
                {
                    b.HasOne("KMChartsUpdater.DAL.Entities.Playlist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KMChartsUpdater.DAL.Entities.PositionFix", null)
                        .WithMany()
                        .HasForeignKey("PositionFixesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
